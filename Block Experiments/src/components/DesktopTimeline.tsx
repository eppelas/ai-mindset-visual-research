  ...
  return (
    <div className="w-full max-w-[1200px] mx-auto py-16 px-4 md:px-8 font-sans">
      <div className="flex items-start gap-12 lg:gap-20">
        ...
        <div className="flex-1 bg-white rounded-[32px] border border-black/5 shadow-[0_4px_30px_rgba(0,0,0,0.03)] p-12 lg:p-16 relative overflow-hidden min-h-[700px]">
           ...
           <AnimatePresence mode="wait">
             ...
             >
               ...
               <div className="grid grid-cols-1 xl:grid-cols-2 gap-12 border-t border-black/5 pt-12">
                     ...
                     {PROGRAM_WEEKLY_RHYTHM.map((evt) => {
                       ...
                       return (
                         ...
                         >
                           ...
                           {isAdv && <div className="absolute top-2 right-2 text-[10px] font-bold text-[#8DC63F]">*</div>}
                         </div>
                       );
                     })}
                   </div>
                 ...
                 <div className="bg-[#F8F9F8] rounded-[24px] p-8 border border-black/5">
                    ...
                    <p className="text-[13px] leading-[1.6] text-black/50 font-medium mb-8">
                      {advanced.description}
                    </p>
                    
                    <div>
                      <span className="block text-[9px] tracking-[0.2em] font-sans uppercase text-[#A0A0A0] font-bold mb-1">Спикер</span>
                      <span className="text-[#333] font-bold text-[14px]">{advanced.speaker}</span>
                    </div>
                 </div>
