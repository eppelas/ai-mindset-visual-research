  ...
  return (
    <div className="w-full max-w-[1240px] mx-auto py-16 px-4 md:px-8 font-sans">
      <div className="bg-white rounded-[20px] flex flex-col overflow-hidden shadow-[0_4px_30px_rgba(0,0,0,0.03)] border border-black/10 mx-auto max-w-[1100px] relative">
        ...
        <div className="px-14 py-14 relative z-10 min-h-[750px] flex flex-col">
           <AnimatePresence mode="wait">
             ...
             >
               ...
               <div className="grid grid-cols-12 gap-0 relative flex-1">
                  ...
                  <div className="col-span-12 lg:col-span-4 pt-12 lg:pt-0 text-right flex flex-col items-end min-h-[500px]">
                     {/* TAG ALIGNED WITH MAIN TRACK TAG */}
                     <div className="flex items-center gap-2 mb-8 justify-end h-[20px]">
                        <span className="text-black/20 text-[10px] font-mono font-bold uppercase tracking-[0.25em]">ADVANCED TRACK</span>
                        <div className="text-[16px] font-black text-[#8DC63F] leading-none mb-1">*</div>
                     </div>
                     
                     <div className="bg-gradient-to-b from-white/80 via-white/50 to-white/10 border border-black/10 p-10 rounded-[20px] backdrop-blur-[2px] flex flex-col items-end w-full flex-1">
                        <h4 className="text-[32px] md:text-[38px] font-black uppercase text-black/40 tracking-tighter leading-[0.95] mb-6">
                           {advanced.title}
                        </h4>

                        <p className="text-[13px] leading-[1.7] text-black/30 font-medium mb-12 max-w-[240px]">
                           {advanced.description}
                        </p>
                        
                        <div className="mt-auto">
                           <div className="text-[8px] font-mono font-bold uppercase tracking-[0.3em] text-black/20 mb-2">СПИКЕР</div>
                           <div className="text-[15px] font-black text-black/30 font-mono tracking-tighter italic">
                              {advanced.speaker}
                           </div>
                        </div>
                     </div>
