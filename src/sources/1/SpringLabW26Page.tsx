...
export default function SpringLabW26Page() {
  const [isMenuOpen, setIsMenuOpen] = useState(false);
  const [showAllFeedback, setShowAllFeedback] = useState(false);
  const [theme, setTheme] = useState<'winter' | 'spring'>('spring');
            ...
            {[
              ...
              >
                <div className="p-8 md:p-12 flex flex-col h-full">
                  ...
                  <a 
                    href="https://join.aimindset.org/context"
                    className="inline-block border-2 border-current px-8 py-4 text-sm font-black uppercase hover:bg-current hover:text-white transition-all text-center"
                  >
                    ВЫБРАТЬ ПЛАН
                  </a>
                </div>
